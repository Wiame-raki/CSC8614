...
{{
  ...
  "retrieval_query": "university regulations regarding deadline extensions",
  "rationale": "Email administratif demandant des clarifications sur une politique universitaire."
}}
"""